...
def train(args):
    ...
    summary_writer = tf.summary.FileWriter(args.save_dir+'save_models/model', tf.get_default_graph())
    ...
    with tf.device('/device:GPU:0'):
        ...
        for total_iter in tqdm(range(args.total_iter)):
            ...
            _, r_loss,summary_str = sess.run([optim, recon_loss,summary_op], feed_dict={input_photo: photo_batch})
